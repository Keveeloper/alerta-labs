...
const SocialMediaComponent = () => {
  const location = useLocation();
    return (
        <div className={`absolute w-[50px] h-[200px] top-1/3 ${location.pathname === '/contact' ? 'right-10' : 'left-5 md:left-10'} mr-[15px] flex flex-col items-center border border-white  bg-transparent rounded-2xl z-50
