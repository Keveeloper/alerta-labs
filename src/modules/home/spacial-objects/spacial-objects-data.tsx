export const spacialObjectsData = (isMobile: boolean): any => {
          ...
          item: [
              {
                  ...
                  description: `<p class="font-seismic-latin-variable-span" style="margin-bottom: 20px; width: 90%; color: white; font-size: 18px;">
                                ...
                                <p class="font-seismic-latin-variable-span" style="width: ${isMobile ? '90%' : '60%'}; color: white; font-size: 18px;">
                                  ...
                                  your guidelines, to customer-facing digital products like chatbots for email 
                                  or WhatsApp that automize your sales. 
                                </p>`
              },
              {
                  ...
                  fontSize: '60px',
                  fontSizeMobile: '40px',
                  description: `<p class="font-seismic-latin-variable-span" style="margin-bottom: 20px; width: ${isMobile ? '90%' : '60%'}; color: white; font-size: 18px;">
                                  Alerta produces experiences that enhance the ability of your customer 
                                  to interact with your products or services.
                                </p>
                                <p class="font-seismic-latin-variable-span" style="margin-bottom: 20px; width: ${isMobile ? '90%' : '65%'}; color: white; font-size: 18px;">
              ...
              },
              {
                  ...
                  fontSize: '60px',
                  fontSizeMobile: '40px',
                  description: `<p class="font-seismic-latin-variable-span" style="margin-bottom: 20px; width: ${isMobile ? '90%' : '50%'}; color: white; font-size: 18px;">
                                  Add NFTs and cryptocurrency into your brand’s communication strategy with Alerta.
                                </p>
                                <p class="font-seismic-latin-variable-span" style="margin-bottom: 20px; width: ${isMobile ? '90%' : '50%'}; color: white; font-size: 18px;">
                                ...
                                <p class="font-seismic-latin-variable-span" style="width: ${isMobile ? '90%' : '50%'}; color: white; font-size: 18px;">
          ...
          item: [
              {
                  ...
                  fontSize: '60px',
                  fontSizeMobile: '50px',
                  description: `<ul class="font-seismic-latin-variable-span" style="padding-left: 1.2rem; width: ${isMobile ? '90%' : '60%'}; color: white; font-size: 18px; list-style: disc;">
                                  ...
                                  <li>SEO</li>
                                  <li>Web creative and language adaptation</li>
              ...
              },
              {
                  ...
                  fontSize: '60px',
                  fontSizeMobile: '50px',
                  description: `<ul class="mb-auto font-seismic-latin-variable-span" style="padding-left: 1.2rem; width: ${isMobile ? '90%' : '60%'}; color: white; font-size: 18px; list-style: disc;">
              ...
              },
              {
                  ...
                  description: `<ul class="font-seismic-latin-variable-span" style="padding-left: 1.2rem; width: ${isMobile ? '90%' : '60%'}; color: white; font-size: 18px; list-style: disc;">
                                  ...
                                  <li>Advanced analytics to track multilingual website performance.</li>
                                </ul>`
              },
          ],
      },
          ...
          item: [
              {
                  ...
                  description: `<p class="font-seismic-latin-variable-span" style="margin-bottom: 20px; width: ${isMobile ? '90%' : '60%'}; color: white; font-size: 18px;">
                                ...
                                <p class="font-seismic-latin-variable-span" style="width: ${isMobile ? '90%' : '50%'}; color: white; font-size: 18px;">
                                  ...
                                  brand. Focus on client relationships—we’ll handle the tech. 
                                </p>`
              }
          ],
      },
